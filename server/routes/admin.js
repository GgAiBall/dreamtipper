...
router.get('/upload/template', adminAuth, (req, res) => {
  try {
    ...
    const guide = XLSX.utils.aoa_to_sheet([
      ...
      ['信心星级', '1~5 整数'],
      ['权限', '免费 / 月度 / 年度'],
      ['胜平负推荐', '下拉选择或手动输入：胜 / 平 / 负'],
      ['让球盘口', '让几球：+1/+2/+3/+4/-1/-2/-3/-4 或手动输入'],
      ['让球结果', '让胜 / 让平 / 让负'],
      ['比分推荐', '1:0/2:0/2:1/3:0/3:1/3:2/4:0/4:1/4:2/5:0/5:1/5:2/胜其它/0:0/1:1/2:2/3:3/平其他/0:1/0:2/1:2/0:3/1:3/2:3/0:4/1:4/2:4/0:5/1:5/2:5/负其它'],
      ['进球推荐', '0/1/2/3/4/5/6/7+'],
      ['半全场推荐', '胜胜/胜平/胜负/平胜/平平/平负/负胜/负平/负负'],
